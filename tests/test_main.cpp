...
int main(){
    ...
    text_rt.add_relocation(0x1E, 0x0B, 0x14);
    ...
    cf.add_symbol("NULL\0", 0, -1, 0, 0x3, 0, "");
    cf.add_symbol("ExitProcess\0", 0, 0, 0, 0x2, 0, "");
    cf.add_symbol("GetStdHandle\0", 0, 0, 0, 0x2, 0, "");
    cf.add_symbol("WriteConsoleA\0", 0, 0, 0, 0x2, 0, "");
    cf.add_symbol("msg\0", 0, 1, 0, 0x3, 0, "");
    cf.add_symbol("msg.len\0", 0xF, -1, 0, 0x3, 0, "");
    cf.add_symbol("dummy\0", 0, 2, 0, 0x3, 0, "");
    cf.add_symbol("main\0", 0, 3, 0, 0x2, 0, "");
